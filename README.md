...
## Input File Formats
The recommended input format is [**VCF**](http://www.internationalgenome.org/wiki/Analysis/vcf4.0/) or **FASTA** ending with *.fasta or *fa. For alignment, bwa version 0.7.17 is used. 
