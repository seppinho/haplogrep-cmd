...
Download and execute the [latest release](https://github.com/seppinho/haplogrep-cmd/releases/download/v2.1.11/haplogrep-2.1.11.jar) (v2.1.11). 
 
      java -jar haplogrep-2.1.11.jar --in <input> --format vcf/hsd --out haplogroups.txt
